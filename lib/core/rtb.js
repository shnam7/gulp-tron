...
class RTB extends events_1.EventEmitter {
    ...
    src(src) {
        ...
        this._stream = require('gulp').src(src, (_a = mopts.gulp) === null || _a === void 0 ? void 0 : _a.src);
    ...
    dest(path) {
        ...
        return this.pipe(require('gulp').dest(path || this.conf.dest || '.', (_a = this.moduleOptions.gulp) === null || _a === void 0 ? void 0 : _a.dest));
    }
