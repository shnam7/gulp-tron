...
-   **Utility Functions**:
    -   `arrayify` ([src/utils/arrayify.ts](../src/utils/arrayify.ts))
    -   `copy` ([src/utils/copy.ts](../src/utils/copy.ts))
    -   `exec`, `isGlob`, `Glob` ([src/utils/index.ts](../src/utils/index.ts))

### Example: Custom Task

```ts
tron.task('styles', bs =>
    bs.src('src/**/*.scss').pipe(/* Sass plugin */).pipe(/* PostCSS plugin */).dest('dist/css'),
)
```
